...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, listProduk activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    public boolean validateFields() {
        if(addTaskTitle.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Masukkan judul yang valid", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(addTaskDescription.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Masukkan Deskripsi", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(taskDate.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Masukkan Tanggal", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(taskTime.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Masukkan Jam", Toast.LENGTH_SHORT).show();
            return false;
        }
        else if(taskEvent.getText().toString().equalsIgnoreCase("")) {
            Toast.makeText(activity, "Masukkan Acara", Toast.LENGTH_SHORT).show();
            return false;
        }
        else {
            return true;
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                Helper4Class createTask = new Helper4Class();
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(getActivity(), "Agenda Kamu Telah Ditambahkan", Toast.LENGTH_SHORT).show();
                dismiss();
