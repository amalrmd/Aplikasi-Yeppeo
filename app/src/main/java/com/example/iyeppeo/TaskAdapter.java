...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    private listProduk context;
    private LayoutInflater inflater;
    private List<Helper4Class> taskList;
    ...
    public TaskAdapter(listProduk context, List<Helper4Class> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        Helper4Class task = taskList.get(position);
        ...
        holder.status.setText(task.isComplete() ? "SELESAI" : "MENUNGGU");
    ...
    public void showPopUpMenu(View view, int position) {
        final Helper4Class task = taskList.get(position);
